    ...
    <div>
      ...
      <div className={babyCare.container}>
        <div className={babyCare.section}>
          ...
          <div className={babyCare.botomtxt}>
            <span className={babyCare.text}>Hold your baby with care</span>
          </div>
        </div>
        ...
        <div className={babyCare.section}>
          ...
          <div className={babyCare.botomtxt}>
            <span className={babyCare.text}>
              Make the baby sleeping on the back
            </span>
          </div>
        </div>
        ...
        <div className={babyCare.section}>
          ...
          <div className={babyCare.botomtxt}>
            <span className={babyCare.text}>Give full body massages</span>
          </div>
        </div>
        ...
        <div className={babyCare.section}>
          ...
          <div className={babyCare.botomtxt}>
            <span className={babyCare.text}>Apply moisturizer</span>
          </div>
        </div>
      </div>
      ...
      <div className={babyCare.container}>
        <div className={babyCare.section}>
          ...
          <div className={babyCare.botomtxt}>
            <span className={babyCare.text}>
              Give only sponge baths in the beginning
            </span>
          </div>
        </div>
        ...
        <div className={babyCare.section}>
          ...
          <div className={babyCare.botomtxt}>
            <span className={babyCare.text}>Breastfeed on time</span>
          </div>
        </div>
        ...
        <div className={babyCare.section}>
          ...
          <div className={babyCare.botomtxt}>
            <span className={babyCare.text}>Keep hand sanitizer handy</span>
          </div>
        </div>
        ...
        <div className={babyCare.section}>
          ...
          <div className={babyCare.botomtxt}>
            <span className={babyCare.text}>Do diaper change on time</span>
          </div>
        </div>
      </div>
    </div>
