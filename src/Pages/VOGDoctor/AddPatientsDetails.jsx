...
function MyForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!formData.PregnancyRegNo) {
        validationErrors.PregnancyRegNo = "Pregnancy Registration Number is required";
      }

    if (!formData.EligibilityRegNo) {
        validationErrors.EligibilityRegNo = "Eligibility Register Number is required";
      }
  ...
  return (
    <Box>
      <Box sx={{justifyContent:"center",alignContent:"center"}}>
        <div >
          <span className="text-xl text-[#2A777C] font-bold ">Hospital Clinic Care</span>
        </div>
      </Box>
      <Box
        component="form"
