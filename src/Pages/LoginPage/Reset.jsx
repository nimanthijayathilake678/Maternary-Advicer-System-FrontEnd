      ...
      <Stack alignItems="center" justifyContent="center">
        ...
        >
          ...
          <Stack display="flex" direction="column" alignItems="center">
            <TitleBox>
              <Typography variant="h5" color="black">Reset Password</Typography>
            </TitleBox>

            <UserText>
              <Typography variant="h8" color="black">Password must be:</Typography>
            </UserText>
            ...
            <Stack display="flex" direction="column" spacing={2}>
              <UserText>
                <Typography variant="h8" color="black">Enter New Password</Typography>
              </UserText>
              ...
              <UserText>
                <Typography variant="h8" color="black">Confirm New Password</Typography>
              </UserText>
