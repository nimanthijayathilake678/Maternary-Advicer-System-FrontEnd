...
const rows = [
  ...
  createData("Unusual colored or foul-smelling discharge from the vagina",<ClearSharpIcon sx={{color:'red'}}/>),
  createData("Abortion",<ClearSharpIcon sx={{color:'red'}}/>),
  createData("Stillbirths",<ClearSharpIcon sx={{color:'red'}}/>),
  createData("Infant mortality",<ClearSharpIcon sx={{color:'red'}}/>),
  createData("Tubal Pregnancy (Ectopic)",<ClearSharpIcon sx={{color:'red'}}/>),
  createData("Itching in or around genitals",<DoneSharpIcon sx={{color:'green'}}/>,<ClearSharpIcon sx={{color:'red'}}/>),
  createData("Any surgery on reproductive organs",<DoneSharpIcon sx={{color:'green'}}/>,<ClearSharpIcon sx={{color:'red'}}/>),
  createData("Reproductive organs",<ClearSharpIcon sx={{color:'red'}}/>,<ClearSharpIcon sx={{color:'red'}}/>),
  createData("Have any problems with sex ",<DoneSharpIcon sx={{color:'green'}}/>,<ClearSharpIcon sx={{color:'red'}}/>),
  createData("Satisfied with the sexual relationship",<DoneSharpIcon sx={{color:'green'}}/>,<ClearSharpIcon sx={{color:'red'}}/>),
  createData("Breast self-exmination once a month",<DoneSharpIcon sx={{color:'green'}}/>),
  createData('Have any family planning system',<DoneSharpIcon sx={{color:'green'}}/>),
  createData('Family Planning Method',<ClearSharpIcon sx={{color:'red'}}/>),
  createData('Delay first child',<ClearSharpIcon sx={{color:'red'}}/>),
  createData('Time take to delay first child',<ClearSharpIcon sx={{color:'red'}}/>),
];
