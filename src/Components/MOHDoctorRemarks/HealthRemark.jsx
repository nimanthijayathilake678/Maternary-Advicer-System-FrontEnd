...
const rows = [
  createData("Weight", "45", "22"),
  createData("Height ", "Degree" , "Degree"),
  createData("BMI","Software Engineer"),
  createData("Blood type and Rhesus factor  "),
  createData("Hemoglobin Value"),
  createData("Specific cases identified"),
  createData("Dates attended counselling session"),
  
];

export default function HealthRemark(prop) {
